...
namespace EasyMobile.Demo
{
        ...
        where U : LoadAndShowSection<T, U>.CustomElement
    {
        ...
        {
            [SerializeField] protected Button loadAdButton, showAdButton;

            [SerializeField] protected GameObject isAdLoadedToggle;

            protected DemoUtils DemoUtils { get; private set; }

            protected string LoadedStatusMessage => IsAdReady() ? AdReadyMessage : AdNotReadyMessage;
        ...
        {
            [SerializeField] protected Dropdown networkSelector;

            [SerializeField] protected GameObject inputFieldRoot;

            [SerializeField] protected InputField customKeyInputField;

            [SerializeField] protected Toggle enableCustomKey;
            ...
            protected string CustomKey =>
                ...
                enableCustomKey.isOn ? customKeyInputField.text : null;
            ...
            {
                enableCustomKey.onValueChanged.AddListener(flag => { inputFieldRoot.gameObject.SetActive(flag); });
            }

            protected abstract void InitNetworkDropdown();
        }

        [SerializeField] private T defaultElement = null;

        [SerializeField] private U customElement = null;
