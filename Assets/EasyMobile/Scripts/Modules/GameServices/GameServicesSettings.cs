...
namespace EasyMobile
{
    ...
    public partial class GameServicesSettings
    {
        ...
        /// </summary>
        /// <value><c>true</c> if is auto init; otherwise, <c>false</c>.</value>
        public bool IsAutoInitAfterUserLogout
        {
            get => mAutoInitAfterUserLogout;
            set => mAutoInitAfterUserLogout = value;
        }
        ...
        public int AndroidMaxLoginRequests => mAndroidMaxLoginRequests;
        ...
        {
            get => mGpgsDebugLogEnabled;
            set => mGpgsDebugLogEnabled = value;
        }
        ...
        {
            get => mGpgsPopupGravity;
            set => mGpgsPopupGravity = value;
        }
        ...
        {
            get => mGpgsShouldRequestServerAuthCode;
            set => mGpgsShouldRequestServerAuthCode = value;
        }
        ...
        {
            get => mGpgsForceRefreshServerAuthCode;
            set => mGpgsForceRefreshServerAuthCode = value;
        }
        ...
        {
            get => mGpgsOauthScopes;
            set => mGpgsOauthScopes = value;
        }
        ...
        [SerializeField] private bool mAutoInitAfterUserLogout = false;
        [SerializeField] [Range(0, 120)] private float mAutoInitDelay = 0;
        [SerializeField] [Range(0, 30)] private int mAndroidMaxLoginRequests = 0;

        // GPGS setup.
        [SerializeField] private bool mGpgsDebugLogEnabled = false;
        [SerializeField] private GpgsGravity mGpgsPopupGravity = GpgsGravity.Top;
        [SerializeField] private bool mGpgsShouldRequestServerAuthCode = false;
        [SerializeField] private bool mGpgsForceRefreshServerAuthCode = false;
        [SerializeField] private string[] mGpgsOauthScopes = null;

        // Leaderboards & Achievements
        [SerializeField] private Leaderboard[] mLeaderboards = null;
        [SerializeField] private Achievement[] mAchievements = null;

        // GPGS setup resources.
        // These fields are only used in our editor, hence the warning suppression.
#pragma warning disable 0414
        [SerializeField] private string mAndroidXmlResources = string.Empty;
