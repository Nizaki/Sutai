...
namespace EasyMobile.Editor
{
    ...
    {
        private const string UtilityModuleLabel = "UTILITIES";

        private const string UtilityModuleIntro =
        ...
        private void UtilityModuleGUI()
        {
            ...
            DrawUppercaseSection("REQUEST_DIALOG_CONFIG_FOLDOUT_KEY", "STORE REVIEW | RATING DIALOG", () =>
            {
                EditorGUILayout.HelpBox(
                    "Since Easy Mobile Pro 2.8.0 we use native review popups provided by iOS and Android which do not require any setup here.",
                    MessageType.Info);
