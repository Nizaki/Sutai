...
namespace EasyMobile.Editor
{
    ...
    {
        private const string AndroidPermissionsIntroMsg =
            "This section displays the Android permissions and features required by each active module. These values will be added to the AndroidManifest.xml of the exported APK or AndroidStudio project.";

        private const string iOSInfoPlistKeysIntroMsg =
            "This section displays the keys to be added to the Info.plist of the exported Xcode project. The values shown here are for summary purpose and are not editable. To modify them " +
            "please go to the settings page of the corresponding module.";

        private const string AutoInitializationOnMsg =
            "Easy Mobile runtime will initialize itself automatically as soon as the app launches. If you want to perform the initialization manually, disable this option and call the RuntimeManager.Init() method in your code.";

        private const string AutoInitializationOffMsg =
            "Auto Runtime Initialization is off. Make sure you call RuntimeManager.Init() before using Easy Mobile API.";
        ...
        private void DrawBuildSectionGUI()
        {
            ...
            {
                var msg = AutoInitializationOnMsg;
